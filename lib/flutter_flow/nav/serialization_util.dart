      ...
      case ParamType.SupabaseRow:
        ...
        switch (T) {
          ...
          case CoinProductOptionsRow:
            return CoinProductOptionsRow(data);
          case AuthorApplicationsRow:
            return AuthorApplicationsRow(data);
          case UserAssignmentsRow:
            return UserAssignmentsRow(data);
          case AbTestResultsRow:
            return AbTestResultsRow(data);
          case BooksRow:
            return BooksRow(data);
          case BookScoresRow:
            return BookScoresRow(data);
          case UserPreferencesRow:
            return UserPreferencesRow(data);
          case AbTestsRow:
            return AbTestsRow(data);
          case FcmTokensRow:
            return FcmTokensRow(data);
          case CoinPackagesRow:
            return CoinPackagesRow(data);
          case ChaptersRow:
            return ChaptersRow(data);
          case ClickThroughsRow:
            return ClickThroughsRow(data);
          case ActivityRow:
            return ActivityRow(data);
          case DailyPassRow:
            return DailyPassRow(data);
          case TropesRow:
            return TropesRow(data);
          case StripePayoutsRow:
            return StripePayoutsRow(data);
          case CoinTransactionsRow:
            return CoinTransactionsRow(data);
          case PurchasesRow:
            return PurchasesRow(data);
          case PagesRow:
            return PagesRow(data);
          case UserCommentsRow:
            return UserCommentsRow(data);
          case ChapterUnlocksRow:
            return ChapterUnlocksRow(data);
          case HomeAdsRow:
            return HomeAdsRow(data);
          case UsersRow:
            return UsersRow(data);
          case ClicksRow:
            return ClicksRow(data);
          case CoinsRow:
            return CoinsRow(data);
          default:
            return null;
        }
