...
class AuthMainWidget extends StatefulWidget {
  ...
  /// If a user is anonymous we need to pass the UID to the newly created user.
  final String? uid;

  static String routeName = 'auth_main';
  static String routePath = 'authMain';
...
class _AuthMainWidgetState extends State<AuthMainWidget>
  ...
  void initState() {
    ...
    _model.passwordCreateTextController ??=
        TextEditingController(text: _model.password);
                                                    ...
                                                    onPressed: () async {
                                                      ...
                                                      await currentUserReference!
                                                        ...
                                                        lastReadNotification:
                                                            getCurrentTimestamp,
                                                        dailyPassLastActive: functions
                                                            .returnYesterdaysDate(
                                                                getCurrentTimestamp),
                                                      ));
                                                      await actions
                                                          .closeKeyboard();
