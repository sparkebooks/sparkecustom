            ...
            child: Column(
              ...
              children: [
                ...
                Expanded(
                  child: Padding(
                    padding:
                        EdgeInsetsDirectional.fromSTEB(20.0, 1.0, 20.0, 0.0),
                      ...
                      child: Column(
                        ...
                        children: [
                                ...
                                children: [
                                  AuthUserStreamWidget(
                                    builder: (context) => Text(
                                      'Selected Tropes ${'(${valueOrDefault<String>(
                                  ...
                                  Text(
                                    'Your selected tropes are below.',
                                    style: FlutterFlowTheme.of(context)
                                        .labelMedium
                                        .override(
                                          fontFamily: 'Figtree',
                          ...
                          Builder(
                            builder: (context) {
                              final tropes =
                                  FFAppState().selectedTropes.toList();
                              ...
                              return Wrap(
                                ...
                                children:
                                    List.generate(tropes.length, (tropesIndex) {
                                  final tropesItem = tropes[tropesIndex];
                                  return InkWell(
                                    splashColor: Colors.transparent,
                                    focusColor: Colors.transparent,
                                    hoverColor: Colors.transparent,
                                    ...
                                    onTap: () async {
                                      FFAppState()
                                          .removeFromSelectedTropes(tropesItem);
                                      safeSetState(() {});
                                      _model
                                          .removeFromSelectedTropes(tropesItem);
                                      safeSetState(() {});
                      ...
                      onPressed: () async {
                        ...
                        await currentUserReference!.update({
                          ...createUsersRecordData(
                            displayName: _model.cityTextController.text.trim(),
                          ...
                          ...mapToFirestore(
                            {
                              'selected_tropes': _model.selectedTropes,
                            },
                          ),
                        });
                        context.safePop();
