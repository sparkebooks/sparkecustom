                                  ...
                                  Expanded(
                                    child: FutureBuilder<List<CoinsRow>>(
                                      ...
                                      builder: (context, snapshot) {
                                        ...
                                        List<CoinsRow> containerCoinsRowList =
                                            snapshot.data!;

                                        final containerCoinsRow =
                                            containerCoinsRowList.isNotEmpty
                        ...
                        Padding(
                          ...
                          child: FFButtonWidget(
                            onPressed: () async {
                              ...
                              FFAppState().selectedTypographyFamily =
                                  SelectedTypography.Figtree;
                              ...
                              FFAppState()
                                  .alreadyFetchedABTestCoverAndBlurbIds = [];
                              ...
                              context.goNamedAuth(
                                  AuthWelcomeWidget.routeName, context.mounted);
                            },
                            text: 'Log Out',
