...
import 'modal_account_options_model.dart';
export 'modal_account_options_model.dart';

class ModalAccountOptionsWidget extends StatefulWidget {
  const ModalAccountOptionsWidget({super.key});

  @override
  State<ModalAccountOptionsWidget> createState() =>
      _ModalAccountOptionsWidgetState();
}

class _ModalAccountOptionsWidgetState extends State<ModalAccountOptionsWidget> {
  late ModalAccountOptionsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ModalAccountOptionsModel());
                  ...
                  MouseRegion(
                    ...
                    child: InkWell(
                      ...
                      onTap: () async {
                        await launchUrl(Uri(
                            scheme: 'mailto',
                            path: 'support@sparkebooks.com',
                            query: {
                              'subject': 'New Help Ticket from Mobile App',
                              'body': 'I\'m in need of help: ',
                            }
                                .entries
