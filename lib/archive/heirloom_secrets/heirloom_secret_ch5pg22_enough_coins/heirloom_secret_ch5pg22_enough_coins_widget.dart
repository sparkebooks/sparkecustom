...
import 'heirloom_secret_ch5pg22_enough_coins_model.dart';
export 'heirloom_secret_ch5pg22_enough_coins_model.dart';

class HeirloomSecretCh5pg22EnoughCoinsWidget extends StatefulWidget {
  const HeirloomSecretCh5pg22EnoughCoinsWidget({super.key});

  static String routeName = 'HeirloomSecretCh5pg22EnoughCoins';
  static String routePath = 'heirloomSecretCh5pg22EnoughCoins';

  @override
  State<HeirloomSecretCh5pg22EnoughCoinsWidget> createState() =>
      _HeirloomSecretCh5pg22EnoughCoinsWidgetState();
}

class _HeirloomSecretCh5pg22EnoughCoinsWidgetState
    extends State<HeirloomSecretCh5pg22EnoughCoinsWidget> {
  late HeirloomSecretCh5pg22EnoughCoinsModel _model;
  ...
  void initState() {
    super.initState();
    _model =
        createModel(context, () => HeirloomSecretCh5pg22EnoughCoinsModel());
