...
import 'heirloom_secret_ch5pg22_low_coins_model.dart';
export 'heirloom_secret_ch5pg22_low_coins_model.dart';

class HeirloomSecretCh5pg22LowCoinsWidget extends StatefulWidget {
  const HeirloomSecretCh5pg22LowCoinsWidget({super.key});

  static String routeName = 'HeirloomSecretCh5pg22LowCoins';
  static String routePath = 'heirloomSecretCh5pg22LowCoins';

  @override
  State<HeirloomSecretCh5pg22LowCoinsWidget> createState() =>
      _HeirloomSecretCh5pg22LowCoinsWidgetState();
}

class _HeirloomSecretCh5pg22LowCoinsWidgetState
    extends State<HeirloomSecretCh5pg22LowCoinsWidget> {
  late HeirloomSecretCh5pg22LowCoinsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => HeirloomSecretCh5pg22LowCoinsModel());
