import '/archive/new_unlock_daily_pass_used/new_unlock_daily_pass_used_widget.dart';
import '/flutter_flow/flutter_flow_theme.dart';
import '/flutter_flow/flutter_flow_util.dart';
import '/new_components/modal_account_options/modal_account_options_widget.dart';
import 'package:flutter/material.dart';
import 'heirloom_secret_ch5pg22_daily_pass_used_model.dart';
export 'heirloom_secret_ch5pg22_daily_pass_used_model.dart';

class HeirloomSecretCh5pg22DailyPassUsedWidget extends StatefulWidget {
  const HeirloomSecretCh5pg22DailyPassUsedWidget({super.key});

  static String routeName = 'HeirloomSecretCh5pg22DailyPassUsed';
  static String routePath = 'heirloomSecretCh5pg22DailyPassUsed';

  @override
  State<HeirloomSecretCh5pg22DailyPassUsedWidget> createState() =>
      _HeirloomSecretCh5pg22DailyPassUsedWidgetState();
}

class _HeirloomSecretCh5pg22DailyPassUsedWidgetState
    extends State<HeirloomSecretCh5pg22DailyPassUsedWidget> {
  late HeirloomSecretCh5pg22DailyPassUsedModel _model;
  ...
  void initState() {
    super.initState();
    _model =
        createModel(context, () => HeirloomSecretCh5pg22DailyPassUsedModel());
                          ...
                          builder: (context) {
                            return GestureDetector(
                              ...
                              child: Padding(
                                ...
                                child: Container(
                                  height: 350.0,
                                  child: NewUnlockDailyPassUsedWidget(),
                                ),
                              ),
                            );
                          },
