...
import 'tropes_page_search_results_model.dart';
export 'tropes_page_search_results_model.dart';

class TropesPageSearchResultsWidget extends StatefulWidget {
  const TropesPageSearchResultsWidget({super.key});

  static String routeName = 'TropesPageSearchResults';
  static String routePath = 'tropesPageSearchResults';

  @override
  State<TropesPageSearchResultsWidget> createState() =>
      _TropesPageSearchResultsWidgetState();
}

class _TropesPageSearchResultsWidgetState
    extends State<TropesPageSearchResultsWidget> {
  late TropesPageSearchResultsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TropesPageSearchResultsModel());
                            ...
                            child: Padding(
                              ...
                              child: TextFormField(
                                ...
                                decoration: InputDecoration(
                                  labelText:
                                      'Search for titles or books here...x',
                                ...
                                Container(
                                  ...
                                  child: Padding(
                                    ...
                                    child: InkWell(
                                      ...
                                      onTap: () async {
                                        context.pushNamed(
                                            HeirloomSecretPg1Widget.routeName);
                                      },
                                      onLongPress: () async {
                                        await showModalBottomSheet(
                                          isScrollControlled: true,
