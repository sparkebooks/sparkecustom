...
import 'trope_alpha_model.dart';
export 'trope_alpha_model.dart';

class TropeAlphaWidget extends StatefulWidget {
  const TropeAlphaWidget({super.key});

  static String routeName = 'TropeAlpha';
  static String routePath = 'tropeAlpha';

  @override
  State<TropeAlphaWidget> createState() => _TropeAlphaWidgetState();
}

class _TropeAlphaWidgetState extends State<TropeAlphaWidget> {
  late TropeAlphaModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TropeAlphaModel());
